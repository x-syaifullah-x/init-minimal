            ...
            if (!md_a(FS, MD_VERSION_1_2, md_disks, ARRAY_SIZE(md_disks))) {
                if (!sys_c_mkdir(O_LOWER, 0755)) {
                    if (!sys_c_mount(FS, O_LOWER, FS_TYPE, MS_RDONLY | MS_NOATIME | MS_SILENT, NULL)) {
                        ...
                        sys_c_mkdir(O_UPPER "/home/xxx", 0755);
                        sys_c_chown(O_UPPER "/home/xxx", 1000, 1000, NULL);

                        sys_c_mkdir(O_WORK "/home", 0755);
                        sys_c_mkdir(O_WORK "/home/xxx", 0755);
                        
                        sys_c_mount("overlay", "/home/xxx", "overlay", MS_NOATIME | MS_SILENT, "lowerdir=" O_LOWER "/home/xxx,upperdir=" O_UPPER "/home/xxx,workdir=" O_WORK "/home/xxx");
                    }
                }
            }
            sys_c_exit(0);
