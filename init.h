...
static inline long sys_c_write_buf(long __fd, const void *__buf, long len) {
...
// static inline long sys_c_fstat(long __fd, struct stat *__buf) {
...
#define MD_VERSION_0_90 ((const long[]){0, 90})
#define MD_VERSION_1_0 ((const long[]){1, 0})
#define MD_VERSION_1_1 ((const long[]){1, 1})
#define MD_VERSION_1_2 ((const long[]){1, 2})
...
static inline long md_a(const char *__file, const long __versions[MD_VERSION_COLS], const long __disks[][MD_DISK_COLS], const long __n_disk) {
    long fd = sys_c_open(__file, O_RDONLY | __O_NOATIME, NULL);
    mdu_array_info_t info_array = {
    ...
    long ret = sys_c_ioctl(fd, RUN_ARRAY, NULL);
    sys_c_close(fd);
    return ret;
}
#endif  // _INIT_H